...
// Characters that are specific to Simplified Chinese in the user-facing text
// previously shipped by this fork. Use escapes so this regression test does
// not itself contain the characters it rejects.
const SIMPLIFIED_CHINESE_RE = /[\u8fd9\u8bf7\u4ec5\u4e2a\u5f00\u5173\u8fde\u5bf9\u8fc7\u8bf4\u8bfb\u5f55\u53d1\u8f6e\u8bbe\u9009\u8bb0\u65e0\u8be5\u5e93\u9875\u73af\u542f\u52a8\u7801\u7ec8\u590d\u7edf\u50a8\u7b7e\u6743\u8ba4\u663e\u9879\u4e1a\u4e1c\u65f6\u4eec\u4e3a\u4ece\u5e94\u4e60\u7ec4\u8fdc\u8fb9\u5904\u521a]/u;
